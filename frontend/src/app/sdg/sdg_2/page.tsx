...
export default function SDG2Page() {
  ...
  return (
    <div className="space-y-6 p-6">
      ...
      <div className="glass-4 p-6 rounded-2xl shadow-lg">
        <h3 className="text-lg font-semibold mb-4">Visualisasi Data SDG 2</h3>
        <div className="w-full h-96">
          <ResponsiveContainer>
            <BarChart data={dataSDG2}>
              ...
              <Tooltip />
              <Legend />
              <Bar dataKey={Object.keys(dataSDG2[0] || {})[1]} fill="#22c55e" radius={[6, 6, 0, 0]}>
                <LabelList dataKey={Object.keys(dataSDG2[0] || {})[1]} position="top" fill="#fff" />
              </Bar>
            </BarChart>
          </ResponsiveContainer>
        </div>
